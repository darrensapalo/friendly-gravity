...
Planet.prototype.initialize = function(){
	...
	this.lifeSpan = M.random(7000, 35000);
	this.speed = 0.00002;
	...
	this.additionals[0] = new CenteredSprite("planet" + this.kind + "-2", this.position.x, this.position.y, width, height, opacity, scalex, scaley); // fumes
